...
// ];
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Main Section */}
      <div className="main-section-cse main-section relative bg-cover bg-center h-48">
        ...
        <h1 className="topic-heading absolute left-3 bottom-6 text-white text-4xl">Humanities and Social Sciences Department</h1>
        <p className="topic-subtitle absolute left-3 bottom-3 text-white text-sm">Humanities and Social Sciences Department</p>
      </div>
      ...
      <main className="main-container">
        ...
        <div className="navbar flex justify-between p-4">
          <div className="flex">
            ...
            <p className="navbar-item ml-4">Academics</p>
            <p className="navbar-item ml-4">Students</p>
            <p className="navbar-item ml-4">Faculty</p>
            <p className="navbar-item ml-4">Alumni</p>
            <p className="navbar-item ml-4">E-Downloads</p>
            <p className="navbar-item ml-4">Gallery</p>
          </div>
          <div className="flex">
...
<div>
          Welcome to Department of Humanities & Social Sciences
...
<div className="grid lg:grid-cols-2 gap-4 my-4  lg:m-4">
  ...
  {faculties && faculties.map((faculty, index) => {
    if (faculty?.profile?.department === "Humanities and Social Sciences") {
        return (
