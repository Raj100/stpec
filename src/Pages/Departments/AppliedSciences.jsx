  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="main-section-cse main-section relative bg-cover bg-center h-48">
        ...
        <h1 className="topic-heading absolute left-3 bottom-6 text-white text-4xl">Applied Science Department</h1>
        <p className="topic-subtitle absolute left-3 bottom-3 text-white text-sm">Applied Science Department</p>
      </div>
...
<div className="grid lg:grid-cols-2 gap-4 my-4  lg:m-4">
  ...
  {faculties && faculties.map((faculty, index) => {
    if (faculty?.profile?.department === "Applied Science") {
        return (
