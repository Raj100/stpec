...
const MyComponent = () => {
  ...
  //     designation: "Associate Professor, Bio-photonics, Bio-Sensors",
  //     email: "prashanthgr@nitgoa.ac.in",
  ...
  //     designation: "Associate Professor, Signal, Image and Video Processing",
  //     email: "veerakumart@nitgoa.ac.in",
  //     contact: "Not provided",
  //     image: ""
  //   },
  //   {
  ...
  //     designation: "Associate Professor, Signal Processing for Wireless Communication, IoT",
  //     email: "panigrahitr@nitgoa.ac.in",
  //     contact: "Not provided",
  //     image: ""
  //   },
  //   {
  ...
  //     designation: "Associate Professor, Low voltage, Low power analog mixed signal circuit",
  ...
  //     designation: "Associate Professor, Analog and Mixed Signal Design, Data Converter",
  //     email: "nithinkyb@nitgoa.ac.in",
  //     contact: "Not provided",
  //     image: ""
  //   },
  //   {
  ...
  //     designation: "Associate Professor, Antenna Design, Phased Array Design, RF and Microwave",
  //     email: "chatterjeea@nitgoa.ac.in",
  //     contact: "Not provided",
  //     image: ""
  //   },
  //   {
  //     id: 7,
  //     name: "Dr. Lokesh Bramhane",
  //     designation: "Assistant Professor, VLSI Circuit Design, Semiconductor Devices, Biosensors",
  //     email: "bramhanel@nitgoa.ac.in",
  //     contact: "Not provided",
  //     image: ""
  //   },
  //   {
  //     id: 8,
  //     name: "Dr. Subhro Chakrabartty",
  //     designation: "Assistant Professor, Memristor",
  //     email: "chakrabarttys@nitgoa.ac.in",
  //     contact: "Not provided",
  //     image: ""
  //   },
  //   {
  ...
  //     designation: "Assistant Professor, Microwave Imaging, Terahertz Imaging",
  //     email: "erramshettym@nitgoa.ac.in",
  //     contact: "Not provided",
  //     image: ""
  //   },
  //   {
  ...
  //     designation: "Assistant Professor, Infrared Thermography, Thermoelectric Devices",
  //     email: "girill@nitgoa.ac.in",
  //     contact: "Not provided",
  //     image: ""
  //   }
  // ]
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Main Section */}
      <div className="main-section-ece main-section relative bg-cover bg-center h-48">
        ...
        <h1 className="topic-heading absolute left-3 bottom-6 text-white text-4xl">Electronics and Communication Engineering</h1>
        <p className="topic-subtitle absolute left-3 bottom-3 text-white text-sm">ECE Department NIT Goa</p>
      </div>
...
<div className="grid lg:grid-cols-2 gap-4 my-4  lg:m-4">
  ...
  {faculties && faculties.map((faculty, index) => {
    if (faculty?.profile?.department === "Electronics and Communication Engineering") {
        return (
